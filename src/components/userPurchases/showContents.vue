<template>
  <q-card flat
          class=" col-md-8 col-sm-12 show-content-container q-mt-md costume-background-color">
    ...
    <q-tab-panels v-model="activeTab"
      ...
      <q-tab-panel class="costume-background-color"
                   name="pamphlet">
        <div v-for="pamphlet in pamphletsContents"
             :key="pamphlet.id"
            ...
            <a target="_blank"
              ...
              <svg width="50"
                ...
                <g fill="#fff">
                  ...
                  <path
                    d="m247.171875 485.515625c-4.871094 0-8.828125-3.953125-8.828125-8.824219v-88.277344c0-4.875 3.957031-8.828124 8.828125-8.828124 4.875 0 8.828125 3.953124 8.828125 8.828124v88.277344c0 4.871094-3.953125 8.824219-8.828125 8.824219zm0 0"></path>
                </g>
                <path
