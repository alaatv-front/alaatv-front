...
import {PlanList, Plan} from '../../../../../Model/Plan'
...
export default {
    ...
    methods: {
        ...
        setListOfHours(){
            ...
            let end = this.calcTheEndingPoint()
        ...
        setSpaceBetweenEndingTimes() {
            ...
            let lastPlanEnd = this.plans.list[this.plans.list.length - 1].end
        ...
        setSpaceBetweenStartTimes() {
            const parsedStartTime = this.parseTheTime(this.startTime)
            let firstPlanStart = this.plans.list[0].start
