            ...
            <div class="last-content-footer">
              ...
              <div class="last-content-link">
                <q-btn flat
                       ...
                       :to="{ name: 'UserPanel.Asset.EmtahanNahaee.Content', params: {productId: product.id, setId: product.last_content_user_watched.set.id, contentId: product.last_content_user_watched?.id} }">مشاهده</q-btn>
              </div>
            </div>
          </div>
        </q-card-section>
...
export default {
  ...
  methods: {
    gotoProductPage(product) {
      this.$router.push({ name: 'UserPanel.Asset.EmtahanNahaee.ProductPage', params: { productId: product.id } })
    },
    gotoLastContent(product) {
      this.$router.push({ name: 'UserPanel.Asset.EmtahanNahaee.Content', params: { productId: product.id, setId: product.last_content_user_watched.set.id, contentId: product.last_content_user_watched?.id } })
    }
  }
}
</script>
