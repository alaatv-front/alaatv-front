    ...
    <div class="banner-row row">
      <div class="col-lg-6 col-12 chatre-nejat-slogan">
        ...
        <div class="chatre-nejat-description">
          حتما قبل از تماشای فیلم های دوره امتحان نهایی، دوره مشاوره را مشاهده بفرمایید!
        </div>
      </div>
...
import ChatreNejatSetItem from 'src/components/DashboardEmtahanNaahee/ChatreNejatSetItem.vue'
import ProductItemSkeleton from 'src/components/DashboardEmtahanNaahee/ProductItemSkeleton.vue'
import ChatreNejatProductItem from 'src/components/DashboardEmtahanNaahee/ChatreNejatProdutItem.vue'
  ...
  methods: {
    ...
    getProducts(type) {
      ...
      this.$apiGateway.events.getEventsProducts({
        data: { major_id: type },
        eventId: this.$enums.Events.EmtahanNahaee
      }).then(res => {
