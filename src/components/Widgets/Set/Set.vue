    ...
    <q-list>
      ...
      <q-tab-panels v-model="tab"
        ...
        <q-tab-panel name="videos"
                     class="videosPanel">
          <q-virtual-scroll v-if="set.contents.list"
                            v-slot="{ item }"
            ...
            <q-item class="videosPanelItems">
              ...
              <q-item-section top>
                ...
                <q-item-section class="action-section"
                                top
                                side>
                  <div class="text-grey-8 q-gutter-xs">
                    <bookmark v-model:value="item.is_favored"
                              :base-route="getContentBookmarkBaseRoute(item.id)" />
                    <q-btn class="watch-btn"
                           rounded
                           icon="isax:eye"
