    ...
    <template v-slot:entity-crud-table-cell="{inputData, showConfirmRemoveDialog}">
      <q-td :props="inputData.props">
        <template v-if="inputData.props.col.name === 'actions'">
          <q-btn round flat dense size="md" color="info" icon="info" :to="{name:'Admin.BlockManagement.Edit', params: {id: inputData.props.row.id}}">
            <q-tooltip>
              اصلاح
            </q-tooltip>
          </q-btn>
  ...
  data () {
    return {
      ...
      allProps: {
        config: {
          ...
          title: {
            ...
            edit: 'ویرایش بلاک ها',
            create: 'ثبت بلاک جدید',
            index: 'لیست بلاک ها'
          },
          showRouteName: 'Admin.BlockManagement.Show',
          editRouteName: 'Admin.BlockManagement.Edit',
          indexRouteName: 'Admin.BlockManagement.Index',
          createRouteName: 'Admin.BlockManagement.Create',
          tableKeys: {
            data: 'data',
            total: 'meta.total',
      ...
      indexInputs: [
        ...
        { type: 'select', name: 'content_type_id', label: 'نوع بلاک', col: 'col-md-3', multiple: true, value: null, options: [{ label: 'تاریخ ایجاد اولیه', value: 0 }, { label: 'توضیحات مشتری', value: 8 }, { label: 'عملیات', value: 3 }] },
        { type: 'input', name: 'name', value: null, label: 'تگ', col: 'col-md-3' },
        { type: 'input', name: 'description', value: null, label: 'کلاس', col: 'col-md-3' },
        { type: 'input', name: 'description', value: null, label: 'آدرس دلخواه', col: 'col-md-3' },
        { type: 'select', name: 'content_type_id', label: 'فعال / غیر فعال', col: 'col-md-3', value: null, options: [{ label: 'فعال / غیر فعال', value: 0 }, { label: 'فعال', value: 8 }, { label: 'غیر فعال', value: 3 }] }
      ]
    }
  },
  methods: {
