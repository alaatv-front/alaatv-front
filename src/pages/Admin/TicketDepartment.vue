    ...
    <template v-slot:entity-crud-table-cell="{inputData, showConfirmRemoveDialog}">
      <q-td :props="inputData.props">
        <template v-if="inputData.props.col.name === 'actions'">
          <q-btn round flat dense size="md" color="info" icon="info" :to="{name:'Admin.TicketDepartment.Edit', params: {id: inputData.props.row.id}}">
            <q-tooltip>
              اصلاح
            </q-tooltip>
          </q-btn>
      ...
      allProps: {
        config: {
          ...
          title: {
            ...
            edit: 'ویرایش تیکت ها',
            create: 'ثبت تیکت جدید',
            index: 'مدیریت گروه تیکت'
          },
          showRouteName: 'Admin.TicketDepartment.Show',
          editRouteName: 'Admin.TicketDepartment.Edit',
          indexRouteName: 'Admin.TicketDepartment.Index',
          createRouteName: 'Admin.TicketDepartment.Create',
          tableKeys: {
            data: 'data',
            total: 'meta.total',
